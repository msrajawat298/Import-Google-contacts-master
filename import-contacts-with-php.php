...
$google_client_id = '1053384134970-06ce1ter4anufuhv80c3ngqooqqu8i2f.apps.googleusercontent.com'; // paste your client id here
$google_client_secret = 'UW5T7Ng7mURzk_dhgZa81Bgn'; // put your client secret id // 
// if you need to know where you can get this id I give link in the description 
//this is site here you can generate the client id and secret id and enable contact api for access the contact no. to your users.....\
...
if(isset($_SESSION['google_code'])) {
	...
	if (!empty($contacts['feed']['entry'])) {
		foreach($contacts['feed']['entry'] as $contact) {
			...
			$return[] = array (
				...
				'mobile'=> $contact['gd$phoneNumber'][0]['$t'],
	...
	if(!empty($google_contacts)) {
		...
		echo '<table class="table table-striped"><thead><tr><th>Image</th><th>Name</th><th>Mobile No.</th><th>Email</th></tr></thead>';
		...
		foreach ($google_contacts as $contact) {
			...
			if(!empty($contact['mobile'])) {
				...
				echo '<td>mobile No. Not found</td>';
			}
